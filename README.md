...
The following tables can be exported as CSV files:

| Table | Description |
|---|---|
| `participants.csv` | Participant metadata: ID, assigned condition (load × interest), Task 1 category ratings, assigned category for Task 2, and selected product. |
